...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            ["ca", "seed"],
            [
                {"simulation_path": "/path/to/1/BlueConfig", "ca": 1.1, "seed": 1},
                {"simulation_path": "/path/to/2/BlueConfig", "ca": 1.2, "seed": 1},
            ],
            id="01_blueetl",
        ),
        pytest.param(
            ...
            [
                {
                    ...
                    "shotn_sd_pct": 40,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/c26abad3-0861-4f7d-863c-a42daffd029f/000/BlueConfig",
                },
                {
                    "ca": 1.05,
                    "shotn_mean_pct": 60,
                    "shotn_sd_pct": 40,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/c26abad3-0861-4f7d-863c-a42daffd029f/001/BlueConfig",
                },
                {
                    "ca": 1.15,
                    "shotn_mean_pct": 50,
                    "shotn_sd_pct": 40,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/c26abad3-0861-4f7d-863c-a42daffd029f/002/BlueConfig",
                },
                {
                    "ca": 1.15,
                    "shotn_mean_pct": 60,
                    "shotn_sd_pct": 40,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/c26abad3-0861-4f7d-863c-a42daffd029f/003/BlueConfig",
                },
            ],
            id="02_bbpwf_simple",
        ),
            ...
            [
                {
                    ...
                    "fr_scale": 0.125,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/881857e0-c7ae-49c1-a6f6-8a34f43c2e26/000/BlueConfig",
                },
                {
                    "coupled": 1,
                    "ca": 1.15,
                    ...
                    "fr_scale": 1.0,
                    "seed": 628462,
                    "simulation_path": "/path/to/simulation/campaign/881857e0-c7ae-49c1-a6f6-8a34f43c2e26/001/BlueConfig",
                },
            ],
            id="03_bbpwf_coupled",
        ),
